...
function printAllInternalNodes(root) {
    if (root == null) return;
    if (root.leftNode != null && root.rightNode != null) console.log(root.data);
    printAllInternalNodes(root.leftNode);
    printAllInternalNodes(root.rightNode);
}
